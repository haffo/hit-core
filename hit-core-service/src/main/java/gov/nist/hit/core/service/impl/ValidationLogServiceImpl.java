...
public class ValidationLogServiceImpl implements ValidationLogService {
  ...
  @Override
  public ValidationLog generateAndSave(Long userId, TestContext testContext,
              ...
              if (collection != null && collection.size() > 0) {
                for (int i = 0; i < collection.size(); i++) {
                  ...
                  if (path != null && !"".equals(path)) {
                    ...
                    // If there was already at least 1 error for this segment, then increment its
                    // error count.
    ...
    if (testContext != null) {
      ...
      log.setTestingStage(
          (testContext.getStage().name() != null ? testContext.getStage().name() : ""));
    }
