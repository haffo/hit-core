 ...
 */
@Entity
public class SoapConnectivityTestPlan extends SoapTestPlan implements
	...
	protected Set<SoapConnectivityTestCase> testCases = new HashSet<SoapConnectivityTestCase>();

	public SoapConnectivityTestPlan() {
		super();
	}

	public SoapConnectivityTestPlan(String name) {
		setName(name);
	}

	public SoapConnectivityTestPlan(SoapConnectivityTestPlan testPlan) {
	...
	public void addTestCase(SoapConnectivityTestCase testCase) {
		testCases.add(testCase);
		testCase.setParentName(this.name);
	}

	public Set<SoapConnectivityTestCase> getTestCases() {
