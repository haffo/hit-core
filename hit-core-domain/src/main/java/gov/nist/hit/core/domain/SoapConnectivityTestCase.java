 ...
 */
@Entity
public class SoapConnectivityTestCase extends SoapTestCase implements
	...
	protected SoapConnectivityTestContext testContext;

	public SoapConnectivityTestCase() {
		super();
		testStory = new TestStory();
	}

	public SoapConnectivityTestCase(String name) {
		setName(name);
	}
	...
	public SoapConnectivityTestContext getTestContext() {
		return testContext;
	}

	public void setTestContext(SoapConnectivityTestContext testContext) {
