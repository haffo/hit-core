 ...
 */
package gov.nist.healthcare.tools.core.models.documentation;
 ...
 * 
 */
public class KnownIssue extends Document {

	public KnownIssue() {
	}

	public KnownIssue(String title, String description, String path,
			String version) {
