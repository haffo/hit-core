 ...
 */
package gov.nist.healthcare.tools.core.models.validation;
...
public class ValidationResultItem {
	...
	public ValidationResultItem(String description, int column, int line,
			String path, String failureSeverity, String elementContent,
			String assertionDeclaration, String userComment,
			String assertionResult, String failureType) {
		super();
